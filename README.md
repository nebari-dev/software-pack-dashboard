...
_Last regenerated: 2026-08-17T18:30:45Z. Trigger a refresh via the `Refresh pack dashboard` workflow._
...
| [LLM Serving Pack](https://github.com/nebari-dev/llm-serving-pack) | Self-hosted LLM serving via llm-d. Includes per-model OIDC access control, API key management, and Envoy AI Gateway token counting and rate limiting. | Beta | [@dcmcand](https://github.com/dcmcand) | Full | Yes | nebari-llm-serving-0.1.4 (Aug 17) | Aug 17 | – | – |
...
| [Nebari Frames](https://github.com/nebari-dev/nebari-frames) | Nebari Frames is the registry and exchange for Frames: scoped, text-based artifacts that carry organizational context into AI conversations. | Beta | [@dcmcand](https://github.com/dcmcand) | Full | Yes | v0.1.5 (Jul 03) | Aug 17 | – | MCP/Claude requires manual realm config (enable DCR + default-scope audience mapper); see docs/conn… |
...
_Generated: 2026-08-17T18:30:45Z_
